...
public class DebugEnabledCommonTab extends CommonTab {
    ...
    public void initializeFrom(ILaunchConfiguration configuration) {
        ...
        try {
            debuglvl.select(configuration.getAttribute(DebugConfigConstants.WORKFLOW_ENGINE_DEBUG_LEVEL, 2));
    ...
    public void performApply(ILaunchConfigurationWorkingCopy configuration) {
        ...
        configuration.setAttribute(DebugConfigConstants.WORKFLOW_ENGINE_DEBUG_LEVEL, debuglvl.getSelectionIndex());
    }
    ...
    public void setDefaults(ILaunchConfigurationWorkingCopy config) {
        ...
        config.setAttribute(DebugConfigConstants.WORKFLOW_ENGINE_DEBUG_LEVEL, 2);
    }
}
