...
public class TabHelper {
     ...
     *
     * @param tabGroup
     *            the tab group from which the CTabFolder will be created
     * @param dialog
     *            see
     *            {@link ILaunchConfigurationTabGroup#createTabs(ILaunchConfigurationDialog, String)
     * @param mode
     *            see
     *            {@link ILaunchConfigurationTabGroup#createTabs(ILaunchConfigurationDialog, String)
     * @param parent
     *            see {@link Composite#Composite(Composite, int)}
     * @param style
     *            see {@link Composite#Composite(Composite, int)}
     * @return the c tab folder {@link CTabFolder} containing the same tabs as the passed
     *         ILaunchConfigurationTabGroup.
     *         <p>
     *         Note that the resulting tab folder does not support launch-specific methods like
     *         {@link ILaunchConfigurationTabGroup#performApply(ILaunchConfigurationWorkingCopy)}.
     *         If the tab folder is intended to work in an launch configuration environment (e.g. in
     *         a nested tab setting), use delegates to the corresponding methods of the tabs
     *         provided by the passed tabGroup.
     */
    public static CTabFolder createTabFolder(ILaunchConfigurationTabGroup tabGroup, ILaunchConfigurationDialog dialog,
        ...
        // The nested tabs need be created ahead of creating the controls to support providing
        // defaults.
    ...
    public static void createFileInputSection(final Composite parentContainer, final ModifyListener modifyListener,
        ...
        createFileInputSection(parentContainer, modifyListener, groupLabel, fileExtensionRestrictions,
                textFileNameToLoad, dialogTitle, dialogShell, showWorkspaceSelectionButton,
    ...
    public static void createFileInputSection(final Composite parentContainer, final ModifyListener modifyListener,
        ...
        createInputSection(parentContainer, modifyListener, groupLabel, fileExtensionRestrictions, textFileNameToLoad,
                dialogTitle, dialogShell, showWorkspaceSelectionButton, showFileSystemSelectionButton, defaultFileURI,
                allowMultipleSelection, false);
    }

    /**
     * Helper method to create a file selection section in the parent UI container element.
     * 
     * @param parentContainer
     ...
     * @param showWorkspaceSelectionButton
     *            Flag whether a button to select the file from the workspace should be provided.
     * @param showFileSystemSelectionButton
     *            Flag whether a button to select the file from the file system should be provided.
     * @param defaultFileURI
     ...
     */
    private static void createInputSection(final Composite parentContainer, final ModifyListener modifyListener,
            final String groupLabel, final String[] fileExtensionRestrictions, Text textFileNameToLoad,
            String dialogTitle, Shell dialogShell, boolean showWorkspaceSelectionButton,
            boolean showFileSystemSelectionButton, String defaultFileURI, boolean allowMultipleSelection,
            boolean useFolder) {
        ...
        createInputParts(fileInputGroup, modifyListener, fileExtensionRestrictions, textFileNameToLoad, dialogTitle,
                showWorkspaceSelectionButton, showFileSystemSelectionButton, defaultFileURI, allowMultipleSelection,
                useFolder);
    }

    public static void createFileInputParts(Composite parent, ModifyListener modifyListener,
            String[] fileExtensionRestrictions, Text textFileNameToLoad, String dialogTitle, String defaultFileURI) {
        createInputParts(parent, modifyListener, fileExtensionRestrictions, textFileNameToLoad, dialogTitle, true, true,
                defaultFileURI, false, false);
    }

    public static void createInputParts(Composite parent, ModifyListener modifyListener,
            final String[] fileExtensionRestrictions, Text textFileNameToLoad, String dialogTitle,
            boolean showWorkspaceSelectionButton, boolean showFileSystemSelectionButton, String defaultFileURI,
        ...
        // 2011-03-22
        if (showWorkspaceSelectionButton) {
            final Button workspaceButton = new Button(parent, SWT.NONE);
            workspaceButton.setText("Workspace...");
            workspaceButton.addSelectionListener(new WorkspaceButtonSelectionListener(textFileNameToLoad,
                    fileExtensionRestrictions, dialogTitle, shell, useFolder, allowMultipleSelection));
        }

        if (showFileSystemSelectionButton) {
            final Button localFileSystemButton = new Button(parent, SWT.NONE);
        ...
        if (defaultFileURI != null) {
            final Button defaultFileURIButton = new Button(parent, SWT.NONE);
            defaultFileURIButton.setText("Default");
            defaultFileURIButton.addSelectionListener(
                    new DefaultFileSelectionAdapter(textFileNameToLoad, fileExtensionRestrictions, defaultFileURI));
        }
    }
     ...
     *            The default file to present.
     */
    public static void createFolderInputSection(final Composite parentContainer, final ModifyListener modifyListener,
            final String groupLabel, Text textFileNameToLoad, String dialogTitle, Shell dialogShell,
            String defaultFileURI) {

        createInputSection(parentContainer, modifyListener, groupLabel, new String[] {}, textFileNameToLoad,
                dialogTitle, dialogShell, true, true, defaultFileURI, false, true);
    }
