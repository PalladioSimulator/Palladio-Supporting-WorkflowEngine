 ...
 */
public class SequentialBlackboardInteractingJob<BlackboardType extends Blackboard<?>> extends SequentialJob implements
    ...
    /**
     * Executes all contained jobs. Depending on the jobs configuration, the execution cleans up
     * immediately or when all jobs are done.
     *
     * @param monitor
     *            the monitor
