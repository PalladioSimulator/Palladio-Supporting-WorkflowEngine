...
public class LaunchMultiple implements ILaunchConfigurationDelegate {
	...
	public void launch(ILaunchConfiguration configuration, String mode,
		...
		if (tab != null){
			...
			throw new CoreException(new Status(Status.ERROR, this.getClass().getPackage().getName(), "Cannot run launmch multiple before run config has been opened once to initialise tabs. Please start this using the run configuration menu entry."));
		}
