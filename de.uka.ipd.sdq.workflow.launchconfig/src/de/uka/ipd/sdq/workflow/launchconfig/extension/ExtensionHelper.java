...
public class ExtensionHelper {
    ...
    /** The Constant WorkflowExtensionPointAttribute_ExtensionConfigurationBuilder. */
        ...
        for (int i = 0; i < registeredExtensions.length; i++) {
            ...
            for (int j = 0; j < elements.length; j++) {
                ...
                if ((workflId != null) && workflId.equals(workflowId)) {
                    WorkflowExtension extension = new WorkflowExtension(registeredExtension.getUniqueIdentifier(),
                            workflowId);
                    try {
                    ...
                    try {
                        Object o = element
                                .createExecutableExtension(WorkflowExtensionPointAttribute_ExtensionConfigurationBuilder);
