...
/**
 * This class enumerates all registered {@link QVTREngine}s. This class provides
 * access to the extension point.
 * 
...
public final class QVTREngines {
	...
	private static String getAttribute(
			final IConfigurationElement configElement, final String name,
	 ...
	 */
	private static QVTREngines parseEngineConfiguration(
