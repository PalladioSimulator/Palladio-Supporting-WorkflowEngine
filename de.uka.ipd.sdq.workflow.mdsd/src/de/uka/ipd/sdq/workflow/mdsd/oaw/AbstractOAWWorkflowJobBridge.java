...
/**
 * This class allows the use of jobs of the openArchitectureWare workflow engine
 * as part of the SDQ workflow engine.
 * 
 * @param <T>
 *            The class of the oAW job bridged by an specific instance of this
 *            class
...
implements IJob {
	...
	private Logger logger = Logger
			.getLogger(AbstractOAWWorkflowJobBridge.class);
	 ...
	 *            engine
	 * @param slotContents
	 *            Contains models of the oAW workflow engine's blackboard, i.e.,
	 *            models to be transformed by the encapsulated oAW job
	 */
	public AbstractOAWWorkflowJobBridge(T job,
		...
		try {
			...
			if (issues.hasErrors()) {
				...
				throw new JobFailedException(
						"oAW Job configuration is invalid: " + message);
			}
	 ...
	 * 
	 * @param ctx
	 *            The context to configure. Add all the models needed by the oAW
	 *            job
	 */
	...
	/**
	 * Template method in which hiers can add logic to configure their specific
	 * oAW jobs.
	 * 
	 * @param oawJob2
