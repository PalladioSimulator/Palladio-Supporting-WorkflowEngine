 ...
 * for asynchronous processing. It is similar to a delegate in C#.
 * 
...
/**
 * Runs a set of jobs in parallel. The jobs are executed asynchronously and joined on a barrier
 * before continuing the main workflow
 * 
 * @author Steffen Becker
 */
public class ParallelCompositeJob extends AbstractCompositeJob {
     ...
     * 
     * @see
     * de.uka.ipd.sdq.workflow.AbstractCompositeJob#execute(org.eclipse.core.runtime.IProgressMonitor
     * )
     */
    @Override
    public void execute(final IProgressMonitor monitor) throws JobFailedException, UserCanceledException {
        ...
        while (futures.size() > 0 && !singleJobFailed && !monitor.isCanceled()) {
            try {
                Future<Throwable> completedTask = executorCompletionService.take();
    ...
    private void setupExecutor() {
        ...
        executorCompletionService = new ExecutorCompletionService<Throwable>(executorService);
    }
