...
public class WorkflowExceptionHandler {
     ...
     *            If true the workflow exception handler does not handle the exception but throws a
     *            new exception. This is usefull for batch runs or test cases.
     */
    ...
    /**
     * handle critical exceptions. either throws the exception or presents it to the user with an
     * error dialog
     * 
     * @param e
    ...
    /**
     * Handles a non-recoverable exception which is not declared in the interface (e.g., runtime
     * exceptions).
     * 
     * @param e
     *            The exception to handle
